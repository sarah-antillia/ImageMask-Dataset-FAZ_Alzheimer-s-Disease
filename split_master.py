...
"""
Alzheimers-Diagnose-ImageMask-Dataset
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    images_dir = "./FAZ_Alzheimers-Disease_master/images/"
    masks_dir  = "./FAZ_Alzheimers-Disease_master/masks/"
    output_dir = "./FAZ_Alzheimers-Disease-ImageMask-Dataset-V1/"
